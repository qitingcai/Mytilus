...
#NOTE:BEFORE RUNNING THIS, ADD SAMTOOLS TO PATH
...
map_dir="/hb/groups/kelley_lab/tina/mytilus/03_mapping/02_alignment/final_map0603/final_map/F"
...
--gzip -o /hb/groups/kelley_lab/tina/mytilus/04_methylation_extractor/F ${bam_files}
